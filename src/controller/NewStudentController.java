...
public class NewStudentController implements Initializable {
	...
	/**
	 * initializes the Components of the NewStudentView. If the Clipboard is not
	 * null and it contains a Object of the type Student the textfields are
	 * going to be initialized with the proper values out of that Object and the
	 * textfield for the matrikelnummer will be disabled because its the
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		if (session.getClipboard() != null && session.getClipboard() instanceof Student) {
			...
			txtfieldMatrikel.setText(String.valueOf(student.getMatrikelnummer()));
		...
		btnSave.setOnAction(e -> handleSaveStudent(e));
	}

	/**
	 * Handles the Click on the cancelButton. Cleans the clipboard and shows the
	 * showStudents-View.
	 * 
	 * @param e
	 *            unused.
	 ...
	 *            unused.
	 */
	private void handleSaveStudent(ActionEvent e) {
	...
	/**
	 * cleans up the Clipboard and shows the ShowStudents-view. to get the scene
	 * it uses btnCancel but it could've been any other component as well.
	 */
